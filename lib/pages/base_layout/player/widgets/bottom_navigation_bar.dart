      ...
      child: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
            icon: Image.asset(
              selectedIndex == 1
                  ? 'assets/bottom_nav/guarantees_after.png'
                  : 'assets/bottom_nav/guarantees_before.png',
            ),
          ...
          BottomNavigationBarItem(
            ...
            label: translate('base_layout.search_product'),
          ),
          BottomNavigationBarItem(
            icon: Image.asset(
              selectedIndex == 3
          ...
          BottomNavigationBarItem(
            icon: Image.asset(
              selectedIndex == 4
                  ? 'assets/bottom_nav/bell_after.png'
                  : 'assets/bottom_nav/bell_before.png',
            ),
            label: translate('base_layout.notifications'),
          ),
        ],
